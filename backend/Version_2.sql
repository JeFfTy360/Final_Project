...
ALTER TABLE
    "invitations" ADD PRIMARY KEY("id");
ALTER TABLE
...
ALTER TABLE
    "schedules" ADD CONSTRAINT "schedules_service_id_foreign" FOREIGN KEY("service_id") REFERENCES "services"("id");
ALTER TABLE
    "appointments" ADD CONSTRAINT "appointments_client_id_foreign" FOREIGN KEY("client_id") REFERENCES "users"("id");
ALTER TABLE
    "invitations" ADD CONSTRAINT "invitations_company_id_foreign" FOREIGN KEY("company_id") REFERENCES "companies"("id");
ALTER TABLE
    "invitations" ADD CONSTRAINT "invitations_employee_id_foreign" FOREIGN KEY("employee_id") REFERENCES "employees"("id");
ALTER TABLE
